...
public:
	...
	// 结构变量
	CWTLView			m_view;			// 视图窗口，相当于MFC的视图类
	CMyDoc				m_doc;			// 文档类	
	...
	BEGIN_MSG_MAP(CMainFrame)
		...
		//COMMAND_ID_HANDLER(ID_APP_EXIT, OnFileExit)				// 命令栏File-Exit按钮
		//COMMAND_ID_HANDLER(ID_FILE_NEW, OnFileNew)				// 命令栏File-New按钮,工具栏“新建”按钮
