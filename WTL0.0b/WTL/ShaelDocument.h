...
public:
    ...
    virtual bool IsDocumentSafe(const HWND hWnd = NULL, const TCHAR* szCaption = NULL) const;
...
inline bool CDocumentClient::IsDocumentSafe(const HWND hWnd, const TCHAR* szCaption) const
{
    if (IsDocumentVolatile())
    {
        TCHAR szText[256];
        ...
        int bRet = MessageBox(hWnd, szText, szCaption, 
